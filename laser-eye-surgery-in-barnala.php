    ...
    $pageTitle = "Laser eye surgery in Barnala – Trusted Eye Care with Modern Technology";
    $pageDescription = "Get reliable & high-precision solutions for Laser eye surgery in Barnala at Brar Eye Hospital. India's leading name in robotic eye surgeries and patient satisfaction.";
    $pageKeywords = "lasik in barnala, smile pro in barnala, bladeless surgery in barnala, femtosecond laser in barnala";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">barnala</small>
                                </div>
                            </div>
                        </div>
                    </div>
