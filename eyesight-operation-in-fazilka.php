    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 style=" color :white;">Eyesight Operation in fazilka</h1>
        ...
        <div class="container">
            ...
            <section class="intro-section">
                <div class="content-card">
                    <p class="lead">If you're searching for eyesight operation in fazilka, look no further than BRAR EYE Hospital. With more than 21 years of dedicated eye care service and over 1.3 lakh successfully treated patients, we are proud to be a trusted name in eye health.</p>
            ...
            <section id="about-hospital" class="content-section">
                <div class="content-card">
                    ...
                    <p>BRAR EYE Hospital, located in the heart of fazilka, has been a pillar of excellence in eye care since its inception. Our mission has always been to provide world-class eye care using the latest technologies while maintaining a patient-friendly approach.</p>
            ...
            <section id="why-choose-us" class="content-section">
                <div class="content-card">
                    <h2>Why Choose BRAR EYE Hospital for Eyesight Operation in fazilka?</h2>
                    <p>Choosing the right hospital for an eyesight operation in fazilka is a crucial decision. Here's why BRAR EYE Hospital stands out:</p>
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            ...
                            <p>For over two decades, BRAR EYE Hospital has been delivering top-notch eye care services in fazilka and surrounding areas. Our rich experience ensures accurate diagnosis and successful treatment.</p>
                        </div>
            ...
            <section id="operation-types" class="content-section">
                <div class="content-card">
                    ...
                    <p>At BRAR EYE Hospital, we offer a variety of eyesight operations in fazilka tailored to each patient's specific condition:</p>
            ...
            <section id="benefits" class="content-section">
                <div class="content-card">
                    ...
                    <p>Here are some advantages of undergoing an eyesight operation in fazilka at BRAR EYE Hospital:</p>
                ...
                <div class="content-card">
                    ...
                    <div class="testimonials-grid">
                        ...
                        <div class="testimonial-card">
                            ...
                            <p>"Highly experienced doctors and advanced facilities. My eyesight operation in fazilka was smooth and painless."</p>
                            <div class="testimonial-author">
            ...
            <section id="contact" class="content-section contact-section">
                <div class="content-card contact-card">
                    ...
                    <p>Booking your eyesight operation in fazilka with BRAR EYE Hospital is simple:</p>
