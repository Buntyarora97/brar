    ...
    $pageTitle = "Laser eye surgery in Sirsa | Advanced Eye Care Solutions";
    $pageDescription = "Your destination for Laser eye surgery in Sirsa – Brar Eye Hospital combines technology with trust to provide safe, accurate, and affordable treatments.";
    $pageKeywords = "lasik in sirsa, smile pro in sirsa, bladeless surgery in sirsa, femtosecond laser in sirsa";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">sirsa</small>
                                </div>
                            </div>
                        </div>
                    </div>
