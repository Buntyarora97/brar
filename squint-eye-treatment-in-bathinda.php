...
<head>
    ...
    <meta property="og:site_name" content="BRAR EYEHospital">
    ...
    <script type="application/ld+json">
    {
        ...
        "name": "BRAR EYEHospital",
        "description": "Leading squint eye treatment specialist in bathinda with expert strabismus care services",
...
<div class="cornea-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title" style="color:#f17732;">Squint Eye Treatment in bathinda</h1>
    ...
    <section class="vision-correction-section">
        <div class="container">
            <div class="section-header">
                <h2>Squint Surgery at BRAR EYEHospital</h2>
    ...
    <section class="testimonials-section">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Families Trust BRAR EYEHospital for Squint Treatment</p>
            </div>
            
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>My daughter had severe squint since birth. The doctors at BRAR EYEHospital performed surgery when she was 3 years old. Now she has perfect eye alignment and no more teasing at school. Thank you for giving her confidence back!</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Simran Kaur</h4>
                            <span>Mother of 6-year-old patient, bathinda</span>
                        </div>
                        <div class="rating">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>I was hesitant about surgery for my 8-year-old son's squint. But the team at BRAR EYEHospital explained everything clearly. The surgery was quick, and recovery was smooth. His vision has improved dramatically!</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Rajinder Singh</h4>
                            <span>Father of patient, Bathinda</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Timely intervention can protect your child's vision and confidence. We are committed to delivering the best squint eye treatment in bathinda.</p>
