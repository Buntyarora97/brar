...
$pageTitle = "Best ophthalmologist in Bathinda | Safe, Precise & Advanced Surgery";
$pageDescription = "Best ophthalmologist in Bathinda now made accessible with Brar Eye Hospital's 21+ years of experience, trusted by 1.3L+ patients and backed by cutting-edge laser & diagnostic technology.";
$pageKeywords = "eye surgeon in bathinda, MD ophthalmology in bathinda, ocular care expert in bathinda, eye treatment doctor in bathinda";
$canonicalUrl = "https://brareye.com/best-ophthalmologist-in-bathinda.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best ophthalmologist in bathinda with comprehensive eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Ophthalmologist in bathinda</h1>
    ...
    <section class="testimonials-section">
        <div class="container">
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            ...
                            <span>SMILE Pro Patient, bathinda</span>
                        </div>
                        <div class="rating">
                ...
                <div class="testimonial-card">
                    <div class="testimonial-content">
                        <p>My father underwent cataract surgery here. The procedure was quick and painless, and his vision improved significantly. Best ophthalmologist in bathinda without a doubt.</p>
                    </div>
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Simran Kaur</h4>
                            <span>Family of Patient, Bathinda</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Choose the best ophthalmologist in bathinda for comprehensive eye care. From routine check-ups to advanced surgeries, we provide personalized treatment with cutting-edge technology.</p>
