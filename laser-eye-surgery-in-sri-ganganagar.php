...
$pageTitle = "Laser eye surgery in Sri Ganganagar | Eye Health Excellence Since 2001";
$pageDescription = "Trust Brar Eye Hospital for Laser eye surgery in Sri Ganganagar. From diagnostics to advanced surgical care, experience one-stop solutions for all vision problems.";
$pageKeywords = "lasik in sri ganganagar, smile pro in sri ganganagar, bladeless surgery in sri ganganagar, femtosecond laser in sri ganganagar";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">sri ganganagar</small>
                            </div>
                        </div>
                    </div>
                </div>
