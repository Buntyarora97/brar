    ...
    $pageTitle = "Laser eye surgery in Moga | Experience Clarity with Us";
    $pageDescription = "Trust Brar Eye Hospital for Laser eye surgery in Moga. From diagnostics to advanced surgical care, experience one-stop solutions for all vision problems.";
    $pageKeywords = "lasik in moga, smile pro in moga, bladeless surgery in moga, femtosecond laser in moga";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">moga</small>
                                </div>
                            </div>
                        </div>
                    </div>
