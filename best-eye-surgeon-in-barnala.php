...
$pageTitle = "Best eye surgeon in Barnala – Trusted Eye Care with Modern Technology";
$pageDescription = "Brar Eye Hospital offers the best care for Best eye surgeon in Barnala using world-class machines, advanced surgical techniques & experienced eye specialists.";
$pageKeywords = "retina surgeon in barnala, cataract surgeon in barnala, cornea surgeon in barnala, smile eye surgeon in barnala";
$canonicalUrl = "https://brareye.com/best-eye-surgeon-in-barnala.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best eye surgeon in barnala with expert surgical eye care",
...
<div class="surgeon-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Eye Surgeon in barnala</h1>
        ...
        <div class="container">
            <div class="section-content">
                <div class="content-left">
                    <h2>The Best Eye Surgeon in barnala</h2>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="section-header">
                <h2>Why barnala Chooses BRAR EYE Hospital</h2>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Meet the best eye surgeon in barnala at BRAR EYE Hospital and get the right advice and care from day one. Whether it's blurry vision, discomfort, or a known diagnosis - our surgeons are here to help.</p>
