...
$pageTitle = "Children’s Eye Health: Squint, Lazy Eye & Digital Strain – Brar Eye Hospital";
$pageDescription = "Learn the early signs of children’s eye problems like squint, lazy eye, and digital eye strain. Early screening at Brar Eye Hospital, Bathinda ensures healthy vision.";
$pageKeywords = "Children’s eye health Bathinda, squint treatment Bathinda, lazy eye in children, digital eye strain kids, child eye screening Bathinda, Brar Eye Hospital pediatric eye care";
...
@media (max-width: 480px) {
   ...
   <main>
   <!-- Hero Section -->
<section class="hero" style="background:#17a2b8; padding:60px 0; color:#fff;">
    <div class="container">
