<?php
// lasik-surgery-kotkapura.php

$pageTitle = "LASIK Laser Eye Surgery in Kotkapura | Remove Glasses Safely";
$pageDescription = "Get advanced LASIK laser eye surgery in Kotkapura to remove glasses permanently. Safe, quick recovery, and expert eye specialists for clear vision.";
$pageKeywords = "LASIK surgery Kotkapura, laser eye surgery Kotkapura, remove glasses permanently, vision correction Kotkapura";
...
.lasik-cost .lasik-title {
    color: #fff;
}

.lasik-cost .lasik-title::after {
    background-color: #fff;
}
...
.lasik-faq.active .lasik-faq-q::after {
...
<!-- Hero Section -->
<section class="lasik-hero">
    <div class="lasik-hero-content">
        <h1>LASIK Laser Eye Surgery in Kotkapura</h1>
        <p>Advanced laser technology to remove glasses permanently. Safe, quick recovery, and expert eye specialists for clear vision in Kotkapura.</p>
        <a href="#contact" class="lasik-btn">Book Free Consultation</a>
    </div>
</section>

<!-- Introduction Section -->
<section class="lasik-section lasik-white">
    <div class="lasik-container">
        <h2 class="lasik-title">Freedom From Glasses</h2>
        <div class="lasik-intro-wrap">
            <div class="lasik-text">
                <p>Clear vision is essential for everyday life. However, many people struggle with blurry vision due to refractive errors and depend on glasses or contact lenses for years. <strong>LASIK laser eye surgery in Kotkapura</strong> offers a safe, advanced, and effective solution to correct vision permanently.</p>
                ...
                <p>Many reputed eye hospitals in Kotkapura now provide advanced <strong>LASIK treatment</strong> using highly precise laser systems. The procedure is quick, painless, and allows patients to return to their normal routine within a short period.</p>
            ...
            <div class="lasik-img-wrap">
                <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&h=600&fit=crop" alt="LASIK Eye Surgery Kotkapura">
                <div class="lasik-badge">Quick 15 Min Procedure</div>
            </div>
        </div>
    </div>
</section>
...
<section class="lasik-section lasik-light">
    <div class="lasik-container">
        <h2 class="lasik-title">What is LASIK Laser Eye Surgery?</h2>
        <div class="lasik-box">
...
<section class="lasik-section lasik-white">
    <div class="lasik-container">
        <h2 class="lasik-title">Common Vision Problems Treated With LASIK</h2>
...
<!-- Benefits Section -->
<section class="lasik-section" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
    <div class="lasik-container">
        <h2 class="lasik-title">Benefits of LASIK Eye Surgery</h2>
...
<section class="lasik-section lasik-light">
    <div class="lasik-container">
        <h2 class="lasik-title">Who is Eligible for LASIK Surgery?</h2>
        ...
        <div class="lasik-eligibility-wrap">
            <div>
                <p style="margin-bottom: 20px; color: #444; font-size: 1.1rem;">Generally, ideal candidates for <strong>LASIK laser eye surgery in Kotkapura</strong> meet the following criteria:</p>
                <ul class="lasik-list">
                ...
                <ul class="lasik-list" style="margin-top: 15px;">
            ...
            <div class="lasik-img">
                <img src="https://images.unsplash.com/photo-1551076805-e1869033e561?w=800&h=600&fit=crop" alt="LASIK Eligibility Check Kotkapura">
            </div>
        </div>

        <p style="text-align: center; margin-top: 40px; color: #444; font-size: 1.1rem;">If you are unsure about your eye health, it is recommended to schedule a <strong>comprehensive eye checkup in Kotkapura</strong> before considering LASIK surgery.</p>
    </div>
</section>
...
<section class="lasik-section lasik-white">
    <div class="lasik-container">
        <h2 class="lasik-title">LASIK Surgery Procedure – Step by Step</h2>
        ...
        <div class="lasik-steps">
            <div class="lasik-step">
                <div class="lasik-step-num">1</div>
...
<section class="lasik-section lasik-light">
    <div class="lasik-container">
        <h2 class="lasik-title">Recovery After LASIK Surgery</h2>
...
<!-- Cost Section -->
<section class="lasik-section lasik-cost">
    <div class="lasik-container">
        <h2 class="lasik-title">LASIK Surgery Cost in Kotkapura</h2>
        <p style="margin-bottom: 30px;">The cost of <strong>LASIK surgery in Kotkapura</strong> may vary depending on several factors.</p>

        <div class="lasik-factors">
            <div class="lasik-factor">
        ...
        <div class="lasik-price">₹25,000 - ₹80,000</div>
...
<section class="lasik-section lasik-white">
    <div class="lasik-container">
        <h2 class="lasik-title">Types of LASIK Surgery Available</h2>
...
<section class="lasik-section" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
    <div class="lasik-container">
        <h2 class="lasik-title">Why Choose a Trusted Eye Hospital for LASIK in Kotkapura?</h2>
...
<section class="lasik-section lasik-light">
    <div class="lasik-container">
        <h2 class="lasik-title">FAQs About LASIK Surgery</h2>

        <div class="lasik-faq-wrap">
            <div class="lasik-faq">
                <div class="lasik-faq-q">Is LASIK surgery safe?</div>
                <div class="lasik-faq-a">
            ...
            <div class="lasik-faq">
                <div class="lasik-faq-q">How long does LASIK surgery take?</div>
                <div class="lasik-faq-a">
            ...
            <div class="lasik-faq">
                <div class="lasik-faq-q">Is LASIK surgery painful?</div>
                <div class="lasik-faq-a">
            ...
            <div class="lasik-faq">
                <div class="lasik-faq-q">How soon can I see clearly after LASIK?</div>
                <div class="lasik-faq-a">
            ...
            <div class="lasik-faq">
                <div class="lasik-faq-q">Can LASIK permanently remove glasses?</div>
                <div class="lasik-faq-a">
...
<!-- CTA Section -->
<section class="lasik-cta" id="contact">
    <div class="lasik-container">
        <h2>Book Your LASIK Consultation in Kotkapura</h2>
        <p>If you want to enjoy clear vision without glasses or contact lenses, LASIK laser eye surgery in Kotkapura could be the ideal solution. Consult an experienced eye specialist today to determine whether LASIK is suitable for your eyes.</p>
        <a href="tel:+917218272182" class="lasik-btn-white">Call Now: +91 72182-72182</a>
    </div>
</section>
...
<section class="lasik-section lasik-light">
    <div class="lasik-container">
        <h2 class="lasik-title">Contact Us</h2>
...
<script type="application/ld+json">
{
  ...
  "description": "Brar Eye Hospital provides advanced eye care treatments including LASIK, SMILE Pro surgery, cataract surgery and complete ophthalmology services in Kotkapura and Bathinda.",
...
<script>
// FAQ Accordion
    document.querySelectorAll('.lasik-faq-q').forEach(question => {
        question.addEventListener('click', () => {
            const item = question.parentElement;
            const isActive = item.classList.contains('active');
            
            // Close all items
            document.querySelectorAll('.lasik-faq').forEach(faq => {
