...
<?php
$pageTitle = "Best optic nerve Hospital in Ferozepur | Advanced Optic Nerve Diagnosis & Treatment with Experts";
$pageDescription = "Advanced optic nerve treatment in Ferozepur with expert ophthalmologists and modern diagnostic facilities. Trusted eye care since 2001.";
$pageKeywords = "optic nerve specialist Ferozepur, optic nerve treatment Ferozepur, eye nerve diagnosis Ferozepur, ophthalmology expert Ferozepur, neuro-ophthalmology Ferozepur";
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content">
                        <h1 class="hero-title">
                            Best <span class="text-accent">Optic Nerve</span> Hospital in <span class="text-secondary">ferozepur</span>
                        </h1>
        ...
        <div class="container">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="optic-nerve-content">
                        ...
                        <div class="highlight-box mt-4 p-4 bg-light rounded">
                            ...
                            <p class="mb-0">At BRAR EYE Hospital, we specialize in the diagnosis and treatment of optic nerve disorders, making us the best optic nerve hospital in ferozepur.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mb-5">
                <div class="col-lg-8 mx-auto text-center">
                    <p class="lead">BRAR EYE Hospital has been at the forefront of eye care in ferozepur and nearby regions for more than 21+ years. Our long-standing commitment to delivering high-quality treatments has earned us the trust of lakhs of patients.</p>
                    <p>With over 1.3+ lakh successful patient treatments, BRAR EYE Hospital has established itself as the best optic nerve hospital in ferozepur. We focus not just on treating eye diseases but also on improving the overall vision and quality of life for our patients.</p>
                </div>
            </div>
