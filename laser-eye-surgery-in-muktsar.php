    ...
    $pageTitle = "Get Treated by Experts for Laser eye surgery in Muktsar";
    $pageDescription = "Get reliable & high-precision solutions for Laser eye surgery in Muktsar at Brar Eye Hospital. India's leading name in robotic eye surgeries and patient satisfaction.";
    $pageKeywords = "lasik in muktsar, smile pro in muktsar, bladeless surgery in muktsar, femtosecond laser in muktsar";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">muktsar</small>
                                </div>
                            </div>
                        </div>
                    </div>
