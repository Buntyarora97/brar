...
$pageTitle = "  Laser eye surgery in Kotkapura | Advanced Eye Care Solutions";
$pageDescription = "Need Laser eye surgery in Kotkapura? Brar Eye Hospital ensures ethical practices, fast recovery & transparent pricing with expert eye surgeons on board.";
$pageKeywords = "lasik in kotkapura, smile pro in kotkapura, bladeless surgery in kotkapura, femtosecond laser in kotkapura";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Kotkapura</small>
                            </div>
                        </div>
                    </div>
                </div>
