...
$pageTitle = "  Laser eye surgery in Bathinda | Experience Clarity with Us";
$pageDescription = "Laser eye surgery in Bathinda now made accessible with Brar Eye Hospital's 21+ years of experience, trusted by 1.3L+ patients and backed by cutting-edge laser & diagnostic technology.";
$pageKeywords = "lasik in bathinda, smile pro in bathinda, bladeless surgery in bathinda, femtosecond laser in bathinda";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">bathinda</small>
                            </div>
                        </div>
                    </div>
                </div>
