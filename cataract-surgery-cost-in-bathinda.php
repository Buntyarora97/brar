    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 style=" color:white;">Cataract Surgery Cost in bathinda</h1>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <section id="cost-factors" class="content-section">
                <div class="content-card">
                    <h2>Cataract Surgery Cost in bathinda</h2>
                    <p>The cost of cataract surgery in bathinda depends on several factors:</p>
            ...
            <section id="why-choose-us" class="content-section">
                <div class="content-card">
                    <h2>Why Choose BRAR EYE Hospital for Cataract Surgery in bathinda?</h2>
            ...
            <section id="contact" class="content-section contact-section">
                <div class="content-card contact-card">
                    ...
                    <div class="hospital-tagline">
                        ...
                        <p>Contact BRAR EYE Hospital today to schedule your consultation or to know more about cataract surgery cost in bathinda.</p>
                    </div>
                </div>
            </section>
        </div>
