...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cataract surgery specialist in muktsar with advanced eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Cataract Surgery in muktsar</h1>
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Jasbir Kaur</h4>
                            <span>Daughter of patient, muktsar</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
