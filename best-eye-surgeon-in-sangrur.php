...
$pageTitle = "Best eye surgeon in Sangrur | Safe, Precise & Advanced Surgery";
$pageDescription = "Your destination for Best eye surgeon in Sangrur – Brar Eye Hospital combines technology with trust to provide safe, accurate, and affordable treatments.";
$pageKeywords = "retina surgeon in sangrur, cataract surgeon in sangrur, cornea surgeon in sangrur, smile eye surgeon in sangrur";
$canonicalUrl = "https://brareye.com/best-eye-surgeon-in-sangrur.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best eye surgeon in sangrur with expert surgical eye care",
...
<div class="surgeon-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Eye Surgeon in sangrur</h1>
        ...
        <div class="container">
            <div class="section-content">
                <div class="content-left">
                    <h2>The Best Eye Surgeon in sangrur</h2>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="section-header">
                <h2>Why sangrur Chooses BRAR EYE Hospital</h2>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Meet the best eye surgeon in sangrur at BRAR EYE Hospital and get the right advice and care from day one. Whether it's blurry vision, discomfort, or a known diagnosis - our surgeons are here to help.</p>
