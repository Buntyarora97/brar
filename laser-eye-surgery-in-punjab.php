    ...
    $pageTitle = "Laser eye surgery in Punjab | Advanced Eye Care Solutions";
    $pageDescription = "Brar Eye Hospital offers the best care for Laser eye surgery in Punjab using world-class machines, advanced surgical techniques & experienced eye specialists.";
    $pageKeywords = "lasik in punjab, smile pro in punjab, bladeless surgery in punjab, femtosecond laser in punjab";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">punjab</small>
                                </div>
                            </div>
                        </div>
                    </div>
