...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cornea specialist in sangrur with expert corneal care services",
        "url": "<?php echo $canonicalUrl; ?>",
        "telephone": "72182-72182",
        "address": {
            "@type": "PostalAddress",
            "addressLocality": "sangrur",
            "addressRegion": "sangrur",
            "addressCountry": "IN"
        },
        "medicalSpecialty": [
            "Ophthalmology",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Cornea Specialist in sangrur</h1>
            ...
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <div class="contact-methods">
                        ...
                        <a href="contact-brar-eye-hospital-sangrur.php" class="contact-method">
                            <i class="fas fa-calendar-alt"></i>
                            <div>
