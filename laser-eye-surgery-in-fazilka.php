    ...
    $pageTitle = "Laser Eye Surgery in fazilka – Freedom from Specs";
    $pageDescription = "Experience freedom from glasses with advanced LASIK and laser eye surgery in Fazilka.";
    $pageKeywords = "Laser surgery Fazilka, LASIK Fazilka, Laser vision correction Fazilka, Best eye hospital Fazilka, Eye specialist Fazilka";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">fazilka</small>
                                </div>
                            </div>
                        </div>
                    </div>
