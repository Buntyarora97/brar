...
$pageTitle = "Best eye surgeon in amritsar | Experienced Ophthalmologist for Cataract, Glaucoma & LASIK Surgery";
$pageDescription = "Consult the best eye surgeons in amritsar for cataract, squint, glaucoma, and LASIK surgery. Experienced doctors for safe treatment.";
$pageKeywords = "cataract surgery amritsar, motiyabind treatment, eye operation amritsar, lens replacement amritsar, eye surgeon";
$canonicalUrl = "https://brareye.com/cataract-surgery-in-amritsar.php";
 include 'header.php';
?>
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cataract surgery specialist in amritsar with advanced eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Cataract Surgery in amritsar</h1>
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Jasbir Kaur</h4>
                            <span>Daughter of patient, amritsar</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
