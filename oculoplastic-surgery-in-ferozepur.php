    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 style="color:white;">Oculoplastic Surgery in ferozepur</h1>
        ...
        <div class="container">
            ...
            <section class="intro-section">
                <div class="content-card">
                    <p class="lead">If you're looking for expert oculoplastic surgery in ferozepur, BRAR EYE Hospital is your trusted destination. With over 21 years of experience and more than 1.3 lakh patients successfully treated, our hospital is committed to delivering excellence in eye care.</p>
            ...
            <section id="why-us" class="content-section">
                <div class="content-card">
                    <h2>Why Choose BRAR EYE Hospital for Oculoplastic Surgery in ferozepur?</h2>
            ...
            <section id="contact" class="content-section contact-section">
                <div class="content-card contact-card">
                    ...
                    <p>If you're experiencing eyelid issues, excessive tearing, or are interested in rejuvenating your appearance, our expert team is here to help. Contact BRAR EYE Hospital for the most advanced and patient-focused oculoplastic surgery in ferozepur.</p>
