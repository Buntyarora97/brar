...
$pageTitle = "Best eye surgeon in Sirsa – Trusted Eye Care with Modern Technology";
$pageDescription = "Trust Brar Eye Hospital for Best eye surgeon in Sirsa. From diagnostics to advanced surgical care, experience one-stop solutions for all vision problems.";
$pageKeywords = " retina surgeon in sirsa, cataract surgeon in sirsa, cornea surgeon in sirsa, smile eye surgeon in sirsa";
$canonicalUrl = "https://brareye.com/best-eye-surgeon-in-sirsa.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best eye surgeon in sirsa with expert surgical eye care",
...
<div class="surgeon-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Eye Surgeon in sirsa</h1>
        ...
        <div class="container">
            <div class="section-content">
                <div class="content-left">
                    <h2>The Best Eye Surgeon in sirsa</h2>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="section-header">
                <h2>Why sirsa Chooses BRAR EYE Hospital</h2>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Meet the best eye surgeon in sirsa at BRAR EYE Hospital and get the right advice and care from day one. Whether it's blurry vision, discomfort, or a known diagnosis - our surgeons are here to help.</p>
