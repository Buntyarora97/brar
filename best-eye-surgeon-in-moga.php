...
$pageTitle = "Best eye surgeon in Moga – Trusted Eye Care with Modern Technology";
$pageDescription = "Searching for Best eye surgeon in Moga? Visit Brar Eye Hospital – Where every eye is treated with precision, compassion, and latest tools in ophthalmology.";
$pageKeywords = "retina surgeon in moga, cataract surgeon in moga, cornea surgeon in moga, smile eye surgeon in moga";
$canonicalUrl = "https://brareye.com/best-eye-surgeon-in-moga.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best eye surgeon in moga with expert surgical eye care",
...
<div class="surgeon-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Eye Surgeon in moga</h1>
        ...
        <div class="container">
            <div class="section-content">
                <div class="content-left">
                    <h2>The Best Eye Surgeon in moga</h2>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="section-header">
                <h2>Why moga Chooses BRAR EYE Hospital</h2>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Meet the best eye surgeon in moga at BRAR EYE Hospital and get the right advice and care from day one. Whether it's blurry vision, discomfort, or a known diagnosis - our surgeons are here to help.</p>
