    ...
    $pageTitle = "Laser Eye Surgery in Abohar – Freedom from Specs";
    $pageDescription = "Want to live without glasses? Laser eye surgery in Abohar helps correct vision safely. Book your consultation with our experts today.";
    $pageKeywords = "LASIK Abohar, laser vision correction, specs removal Abohar, refractive surgery, eye laser treatment";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">abohar</small>
                                </div>
                            </div>
                        </div>
                    </div>
