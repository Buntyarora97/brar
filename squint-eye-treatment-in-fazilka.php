...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading squint eye treatment specialist in fazilka with expert strabismus care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title" style="color:#f17732;">Squint Eye Treatment in fazilka</h1>
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Simran Kaur</h4>
                            <span>Mother of 6-year-old patient, fazilka</span>
                        </div>
                        <div class="rating">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            ...
                            <span>Father of patient, fazilka</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Timely intervention can protect your child's vision and confidence. We are committed to delivering the best squint eye treatment in fazilka.</p>
