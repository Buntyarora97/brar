...
$pageTitle = "Best cornea specialist in Kotkapura | Advanced Eye Care Solutions";
$pageDescription = "Need Best cornea specialist in Kotkapura? Brar Eye Hospital ensures ethical practices, fast recovery & transparent pricing with expert eye surgeons on board.";
$pageKeywords = "corneal transplant in kotkapura, keratoconus in kotkapura, dry eye care in kotkapura, corneal infections in kotkapura";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cornea specialist in Kotkapura with expert corneal care services",
        "url": "<?php echo $canonicalUrl; ?>",
        "telephone": "72182-72182",
        "address": {
            "@type": "PostalAddress",
            "addressLocality": "Kotkapura",
            "addressRegion": "Kotkapura",
            "addressCountry": "IN"
        },
        "medicalSpecialty": [
            "Ophthalmology",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Cornea Specialist in Kotkapura</h1>
            ...
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <div class="contact-methods">
                        ...
                        <a href="contact-brar-eye-hospital-bathinda.php" class="contact-method">
                            <i class="fas fa-calendar-alt"></i>
                            <div>
