    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 style=" color :white;">Glaucoma Treatment in sangrur</h1>
        ...
        <div class="container">
            ...
            <section class="intro-section">
                <div class="content-card">
                    <p class="lead">Glaucoma is one of the leading causes of irreversible blindness in the world. At BRAR EYE Hospital, sangrur, we understand the seriousness of this condition and offer expert glaucoma care with advanced technology, skilled professionals, and compassionate service.</p>
            ...
            <section id="treatment" class="content-section">
                <div class="content-card">
                    <h2>Glaucoma Treatment in sangrur at BRAR EYE Hospital</h2>
                    <p>At BRAR EYE Hospital, our glaucoma treatment in sangrur is tailored to each patient's condition and needs. While glaucoma cannot be cured, our goal is to manage the disease, prevent progression, and preserve vision.</p>
            ...
            <section id="why-choose-us" class="content-section">
                <div class="content-card">
                    <h2>Why Choose BRAR EYE Hospital for Glaucoma Treatment in sangrur?</h2>
                    ...
                    <div class="features-grid">
                        ...
                        <div class="feature-card">
                            ...
                            <p>Conveniently located in sangrur, easily reachable for patients from sangrur, Faridkot, Muktsar, and nearby towns.</p>
                        </div>
