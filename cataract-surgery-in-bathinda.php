...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cataract surgery specialist in bathinda with advanced eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Cataract Surgery in bathinda</h1>
