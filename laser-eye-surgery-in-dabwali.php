...
$pageTitle = "Laser eye surgery in Dabwali – Brar Eye Hospital’s Expertise";
$pageDescription = "Need Laser eye surgery in Dabwali? Brar Eye Hospital ensures ethical practices, fast recovery & transparent pricing with expert eye surgeons on board.";
$pageKeywords = "lasik in dabwali, smile pro in dabwali, bladeless surgery in dabwali, femtosecond laser in dabwali";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">dabwali</small>
                            </div>
                        </div>
                    </div>
                </div>
