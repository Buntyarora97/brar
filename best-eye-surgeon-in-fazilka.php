...
$pageTitle = "Cataract Surgery in fazilka | Safe, Affordable & Advanced Cataract Removal with Expert Surgeons";
$pageDescription = "Affordable and advanced cataract surgery in fazilka. Safe procedures with expert surgeons and modern technology for clear vision.";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cataract surgery specialist in fazilka with advanced eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Cataract Surgery in fazilka</h1>
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Jasbir Kaur</h4>
                            <span>Daughter of patient, fazilka</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
