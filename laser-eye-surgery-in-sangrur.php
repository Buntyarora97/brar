    ...
    $pageTitle = "Laser eye surgery in Sangrur | Safe, Precise & Advanced Surgery";
    $pageDescription = "Need Laser eye surgery in Sangrur? Brar Eye Hospital ensures ethical practices, fast recovery & transparent pricing with expert eye surgeons on board.";
    $pageKeywords = "lasik in sangrur, smile pro in sangrur, bladeless surgery in sangrur, femtosecond laser in sangrur";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">sangrur</small>
                                </div>
                            </div>
                        </div>
                    </div>
