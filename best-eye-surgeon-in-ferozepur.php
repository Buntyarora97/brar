...
$pageTitle = "Best eye surgeon in Ferozepur | Experienced Ophthalmologist for Cataract, Glaucoma & LASIK Surgery";
$pageDescription = "Consult the best eye surgeons in Ferozepur for cataract, squint, glaucoma, and LASIK surgery. Experienced doctors for safe treatment.";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cataract surgery specialist in ferozepur with advanced eye care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Cataract Surgery in ferozepur</h1>
            ...
            <div class="testimonials-grid">
                ...
                <div class="testimonial-card">
                    ...
                    <div class="testimonial-author">
                        <div class="author-info">
                            <h4>Jasbir Kaur</h4>
                            <span>Daughter of patient, ferozepur</span>
                        </div>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
