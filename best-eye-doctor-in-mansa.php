...
<body>
    ...
    <header class="header" id="home">
        <div class="header-content">
            ...
            <p class="hero-subtitle" style="color:white;">Best Eye Doctor in mansa</p>
            ...
            <div class="features-grid">
                <div class="feature-card scroll-reveal">
                    ...
                    <p class="feature-description">
                        For more than two decades, BRAR EYE Hospital has provided expert eye care services in mansa. 
                ...
                <div class="feature-card scroll-reveal">
                    ...
                    <p class="feature-description">
                        Our team includes some of the most experienced and well-trained eye doctors in mansa. 
    ...
    <section class="section">
        <div class="container">
            ...
            <p class="section-subtitle">
                Patients from mansa and nearby regions trust BRAR EYE Hospital for its integrity, 
