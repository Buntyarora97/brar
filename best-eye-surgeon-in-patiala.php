...
$pageTitle = "Get Treated by Experts for Best eye surgeon in Patiala";
$pageDescription = "Best eye surgeon in Patiala with personalized care, US FDA-approved tech, & Punjab's most experienced team of ophthalmologists at Brar Eye Hospital.";
$pageKeywords = "retina surgeon in patiala, cataract surgeon in patiala, cornea surgeon in patiala, smile eye surgeon in patiala";
$canonicalUrl = "https://brareye.com/best-eye-surgeon-in-patiala.php";
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Best eye surgeon in patiala with expert surgical eye care",
...
<div class="surgeon-page-container">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Eye Surgeon in patiala</h1>
        ...
        <div class="container">
            <div class="section-content">
                <div class="content-left">
                    <h2>The Best Eye Surgeon in patiala</h2>
    ...
    <section class="choose-us-section">
        <div class="container">
            <div class="section-header">
                <h2>Why patiala Chooses BRAR EYE Hospital</h2>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="cta-text">
                    ...
                    <p>Meet the best eye surgeon in patiala at BRAR EYE Hospital and get the right advice and care from day one. Whether it's blurry vision, discomfort, or a known diagnosis - our surgeons are here to help.</p>
