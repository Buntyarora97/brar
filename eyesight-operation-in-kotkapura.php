    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h1 style=" color :white;">Eyesight Operation in Kotkapura</h1>
        ...
        <div class="container">
            ...
            <section class="intro-section">
                <div class="content-card">
                    <p class="lead">If you're searching for eyesight operation in Kotkapura, look no further than Brar Eye Hospital. With more than 21 years of dedicated eye care service and over 1.3 lakh successfully treated patients, we are proud to be a trusted name in eye health.</p>
            ...
            <section id="about-hospital" class="content-section">
                <div class="content-card">
                    ...
                    <p>Brar Eye Hospital, located in the heart of Kotkapura, has been a pillar of excellence in eye care since its inception. Our mission has always been to provide world-class eye care using the latest technologies while maintaining a patient-friendly approach.</p>
            ...
            <section id="why-choose-us" class="content-section">
                <div class="content-card">
                    <h2>Why Choose Brar Eye Hospital for Eyesight Operation in Kotkapura?</h2>
                    <p>Choosing the right hospital for an eyesight operation in Kotkapura is a crucial decision. Here's why Brar Eye Hospital stands out:</p>
                    ...
                    <div class="features-grid">
                        <div class="feature-card">
                            ...
                            <p>For over two decades, Brar Eye Hospital has been delivering top-notch eye care services in Kotkapura and surrounding areas. Our rich experience ensures accurate diagnosis and successful treatment.</p>
                        </div>
            ...
            <section id="operation-types" class="content-section">
                <div class="content-card">
                    ...
                    <p>At Brar Eye Hospital, we offer a variety of eyesight operations in Kotkapura tailored to each patient's specific condition:</p>
            ...
            <section id="benefits" class="content-section">
                <div class="content-card">
                    ...
                    <p>Here are some advantages of undergoing an eyesight operation in Kotkapura at Brar Eye Hospital:</p>
                ...
                <div class="content-card">
                    ...
                    <div class="testimonials-grid">
                        ...
                        <div class="testimonial-card">
                            ...
                            <p>"Highly experienced doctors and advanced facilities. My eyesight operation in Kotkapura was smooth and painless."</p>
                            <div class="testimonial-author">
            ...
            <section id="contact" class="content-section contact-section">
                <div class="content-card contact-card">
                    ...
                    <p>Booking your eyesight operation in Kotkapura with Brar Eye Hospital is simple:</p>
