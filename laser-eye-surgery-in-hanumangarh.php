...
$pageTitle = "Laser eye surgery in Hanumangarh | Advanced Eye Care Solutions";
$pageDescription = "Laser eye surgery in Hanumangarh now made accessible with Brar Eye Hospital's 21+ years of experience, trusted by 1.3L+ patients and backed by cutting-edge laser & diagnostic technology.";
$pageKeywords = "lasik in hanumangarh, smile pro in hanumangarh, bladeless surgery in hanumangarh, femtosecond laser in hanumangarh";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Hanumangarh</small>
                            </div>
                        </div>
                    </div>
                </div>
