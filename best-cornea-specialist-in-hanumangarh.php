...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Leading cornea specialist in hanumangarh with expert corneal care services",
    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">Best Cornea Specialist in hanumangarh</h1>
            ...
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <div class="contact-methods">
                        ...
                        <a href="contact-brar-eye-hospital-hanumangarh.php" class="contact-method">
                            <i class="fas fa-calendar-alt"></i>
                            <div>
