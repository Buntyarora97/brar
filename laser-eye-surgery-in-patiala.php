...
$pageTitle = "Laser eye surgery in Patiala – Brar Eye Hospital’s Expertise";
$pageDescription = "Your destination for Laser eye surgery in Patiala – Brar Eye Hospital combines technology with trust to provide safe, accurate, and affordable treatments.";
$pageKeywords = "lasik in patiala, smile pro in patiala, bladeless surgery in patiala, femtosecond laser in patiala";
                    ...
                    <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">patiala</small>
                            </div>
                        </div>
                    </div>
                </div>
