...
<body>
    ...
    <header class="header" id="home">
        <div class="header-content">
            ...
            <p class="hero-subtitle" style="color:white;">Best Eye Doctor in Sri Ganganagar</p>
            ...
            <div class="features-grid">
                <div class="feature-card scroll-reveal">
                    ...
                    <p class="feature-description">
                        For more than two decades, BRAR EYE Hospital has provided expert eye care services in Sri Ganganagar. 
                ...
                <div class="feature-card scroll-reveal">
                    ...
                    <p class="feature-description">
                        Our team includes some of the most experienced and well-trained eye doctors in Sri Ganganagar. 
    ...
    <section class="section">
        <div class="container">
            ...
            <p class="section-subtitle">
                Patients from Sri Ganganagar and nearby regions trust BRAR EYE Hospital for its integrity, 
