    ...
    $pageTitle = "Laser eye surgery in Ferozepur | Safe & Advanced LASIK, SMILE & Vision Correction Procedures";
    $pageDescription = "Get clear vision with safe and advanced laser eye surgery in Ferozepur. Trusted specialists for LASIK and SMILE procedures.";
    $pageKeywords = "laser surgery Ferozepur, LASIK operation Ferozepur, SMILE eye surgery Ferozepur, bladeless LASIK Ferozepur, laser eye clinic Ferozepur";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">ferozepur</small>
                                </div>
                            </div>
                        </div>
                    </div>
