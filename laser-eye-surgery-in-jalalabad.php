    ...
    $pageTitle = "Laser eye surgery in Jalalabad | Safe & Advanced LASIK, SMILE & Vision Correction Procedures";
    $pageDescription = "Get clear vision with safe and advanced laser eye surgery in Jalalabad. Trusted specialists for LASIK and SMILE procedures.";
    $pageKeywords = "laser eye surgery Jalalabad, LASIK Jalalabad, SMILE surgery Jalalabad, vision correction Jalalabad";
                        ...
                        <div class="testimonial-card bg-white p-4 rounded-4 shadow-sm h-100">
                            ...
                            <div class="testimonial-author d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">jalalabad</small>
                                </div>
                            </div>
                        </div>
                    </div>
